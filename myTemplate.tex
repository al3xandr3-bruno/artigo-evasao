...
\begin{abstract}
School dropout in Brazil has proven to be a major challenge for the educational development of children and young people, especially in the less privileged segments of Brazilian society. Young people who do not complete high school are unable to specialize in higher education courses and, therefore, take on low-wage jobs, perpetuating a cycle of poverty and low socioeconomic indicators. This study aims to evaluate and compare the relevance of socioeconomic and institutional variables, in order to investigate which variables are most strongly associated with high school dropout, using the statistical model of Multiple Linear Regression, evaluated with metrics such as R² and mean squared error. Using data from the Educational Indicators and microdata from the School Census of the Anísio Teixeira National Institute for Educational Studies and Research (INEP), as well as data from the National Household Sample Survey (PNAD) of the Brazilian Institute of Geography and Statistics (IBGE), variables will be extracted that, according to the literature on dropout, best explain continuous school abandonment. The results of this study may help teachers and schools identify and provide more support to students at high risk of dropping out due to social, economic, academic, and/or institutional factors.
...
\begin{abstract}
La deserción escolar en la educación brasileña se ha convertido en un gran desafío para la formación educativa de niños y jóvenes, especialmente en los sectores menos favorecidos de la sociedad brasileña. Los jóvenes que no completan la educación secundaria no pueden especializarse en cursos superiores y, por lo tanto, ocupan empleos de baja remuneración, perpetuando un ciclo de pobreza y bajos indicadores socioeconómicos. Por ello, este estudio tiene como objetivo evaluar y comparar la relevancia de variables socioeconómicas e institucionales, con el fin de investigar cuáles variables se relacionan más fuertemente con la deserción escolar en la educación secundaria, mediante el modelo estadístico de Regresión Lineal Múltiple, evaluado con métricas como R² y el error cuadrático medio. A partir de la base de datos de Indicadores Educativos y microdatos del Censo Escolar del Instituto Nacional de Estudios e Investigaciones Educativas Anísio Teixeira (INEP) y de la base de datos de la Encuesta Nacional por Muestra de Hogares (PNAD), del Instituto Brasileño de Geografía y Estadística (IBGE), se extraerán variables que, según la literatura sobre deserción, mejor explican el abandono escolar continuo. Los resultados de este artículo pueden ayudar a los docentes y a las escuelas a identificar y brindar más apoyo a los estudiantes con alto riesgo de deserción por motivos de índole social, económica, académica y/o institucional.
