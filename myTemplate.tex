...
Estudos recentes sobre o ensino médio brasileiro publicados na revista Roteiro reforçam esse papel da repetência. Com base em séries históricas entre 2007 e 2019, Gusmão (2023) mostra que as taxas de repetência permanecem elevadas na rede pública, afetando principalmente estudantes de baixa renda e alimentando a distorção idade-série, a evasão e o baixo desempenho em avaliações nacionais, como o SAEB. Esses resultados são coerentes com a decisão deste trabalho de tratar a \textit{taxa de reprovação} como um dos principais mecanismos pelos quais o fracasso escolar se converte em abandono.
